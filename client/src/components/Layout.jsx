        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-1 flex justify-between items-center">
          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-6 items-center">
              <li>
                <Link to="/advertisers" className="text-gray-700 font-medium hover:text-blue-600">
                  For Advertisers
                </Link>
              </li>
              <li>
                <Link to="/publishers" className="text-gray-700 font-medium hover:text-blue-600">
                  For Publishers
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/dashboard" className="px-4 py-2 bg-blue-500 text-white rounded-md font-medium hover:bg-blue-600">
                  Log In
                </Link>
              </li>
            </ul>
